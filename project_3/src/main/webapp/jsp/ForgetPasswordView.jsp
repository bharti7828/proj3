...
<body class="p4">
	...
	<div>
      ...
      <div class="input-group">
        ...
        <input type="text" class="form-control" name="login" id="defaultForm-pass" placeholder="Enter email" value="<%=ServletUtility.getParameter("login",request)%>">
      </div>
    </div>
	<font color="red" class="pl-sm-5"><%=ServletUtility.getErrorMessage("login", request)%></font></br>						
							...
							<div class="text-center">
								...
								<input type="submit" name="operation"
									...
									<%-- <input type="submit" name="operation"
									class="btn btn-secondary btn-md" style="font-size:16px"
